    ...
    return (
      <div className="flex flex-col items-center justify-center h-full px-6 text-center">
        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: "spring", stiffness: 200 }}>
          <img src={SPRITE(133)} alt="Eevee" className="w-40 h-40 mx-auto mb-4 drop-shadow-xl" />
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <div className="bg-pokemon-blue/10 rounded-3xl p-5 w-full mb-5 text-center border-4 border-pokemon-blue/20">
            ...
            {q.pokemonId && (
              <img src={SPRITE(q.pokemonId)} alt={q.pokemonName} className="w-24 h-24 mx-auto mb-2" />
            )}
            ...
            <div className="grid grid-cols-3 gap-4 w-full mb-4">
              {q.choices.map((choice) => {
                ...
                return (
                  ...
                  >
                    <img src={SPRITE(pokId)} alt={choice} className="w-16 h-16 object-contain" />
